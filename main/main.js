...
//FUNCTIONS TO CREATE NEW SITES
function hiphopPage() {
    disableSheets();
    klicks++;
    document.getElementById("containerRuta").innerHTML = hiphopFandom;
    document.querySelector("#webnameRuta").innerHTML = "https://www.hiphopfandom.com";
    document.querySelector("#scoreRuta").innerHTML = "KLICKS: " + klicks;


    var scriptsrc=document.createElement("script");
    scriptsrc.setAttribute("async", "false");
    scriptsrc.setAttribute("src", "../hiphop/hiphop.js");
    fileref.setAttribute("href", "../hiphop/hiphop.css");
    document.getElementsByTagName("head")[0].appendChild(fileref);
...
function tompasPage() {
    ...
    var scriptsrc=document.createElement("script");
    scriptsrc.setAttribute("async", "false");
    scriptsrc.setAttribute("src", "../tompas/tompas.js");
...
function murkysPage() {
    disableSheets();
    klicks++;
    document.getElementById("containerRuta").innerHTML = murkysFishies;
    document.querySelector("#webnameRuta").innerHTML = "https://www.murkysfishies.com";
    document.querySelector("#scoreRuta").innerHTML = "KLICKS: " + klicks;


    var scriptsrc=document.createElement("script");
    scriptsrc.setAttribute("async", "false");
    scriptsrc.setAttribute("src", "../murkys/murkys.js");
    fileref.setAttribute("href", "../murkys/murkys.css");
    document.getElementsByTagName("head")[0].appendChild(fileref);
    document.getElementsByTagName("head")[0].appendChild(scriptsrc);
...
function gurkysPage() {
    disableSheets();
    klicks++;
    document.getElementById("containerRuta").innerHTML = gurkyAnglers;
    document.querySelector("#webnameRuta").innerHTML = "https://www.gurkysanglers.com";
    document.querySelector("#scoreRuta").innerHTML = "KLICKS: " + klicks;
    ...
    scriptsrc.setAttribute("async", "false");
    var scriptsrc2=document.createElement("script");
    scriptsrc.setAttribute("src", "../gurkys/gurkys.js");
    scriptsrc2.setAttribute("src", "https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js");
    fileref.setAttribute("href", "../gurkys/gurkys.css");
    document.getElementsByTagName("head")[0].appendChild(fileref);
    document.getElementsByTagName("head")[0].appendChild(scriptsrc);
    document.getElementsByTagName("head")[0].appendChild(scriptsrc2);
}

function festersPage() {
    disableSheets();
    klicks++;
    document.getElementById("containerRuta").innerHTML = festersSpooky;
    document.querySelector("#webnameRuta").innerHTML = "https://www.festersspookypage.com";
    document.querySelector("#scoreRuta").innerHTML = "KLICKS: " + klicks;


    var scriptsrc=document.createElement("script");
    scriptsrc.setAttribute("async", "false");
    scriptsrc.setAttribute("src", "../festers/festers.js");
    fileref.setAttribute("href", "../festers/festers.css");
    document.getElementsByTagName("head")[0].appendChild(scriptsrc);
    document.getElementsByTagName("head")[0].appendChild(fileref);

    console.log(scriptsrc.length);
